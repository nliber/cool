...
// and dump it in namespace experimental::pmr
#if __has_include(<memory_resource>)
#include <memory_resource>
namespace experimental::pmr { using namespace std::pmr; }
#elif __has_include(<experimental/memory_resource>)
#include <experimental/memory_resource>
namespace experimental::pmr { using namespace std::experimental::pmr; }
#endif

namespace cool
{

class SlabMemoryResource : public experimental::pmr::memory_resource
{
public:
    constexpr static size_t defaultslabsize = 1024 * 1024;
